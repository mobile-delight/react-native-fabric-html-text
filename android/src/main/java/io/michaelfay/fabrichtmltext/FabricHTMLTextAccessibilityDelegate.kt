...
/**
 * Accessibility delegate for FabricHTMLTextView that provides proper TalkBack support
 ...
 */
class FabricHTMLTextAccessibilityDelegate(
    private val hostView: FabricHTMLTextView,
