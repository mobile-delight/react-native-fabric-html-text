/**
 * Custom ShadowNodes.h for FabricRichTextSpec
 *
...
#include <react/renderer/components/FabricRichTextSpec/FabricRichTextState.h>
...
JSI_EXPORT extern const char FabricRichTextComponentName[];

/**
 * Custom ShadowNode for FabricRichText with measureContent support.
 *
 ...
 *
 * Uses FabricRichTextState to pass parsed fragments to Kotlin via MapBuffer.
